...
return(
    <>
        <div className="header">
                ...
                <div className="container-fluid">
                    <a className="navbar-brand" href="#">
                        <img
                            ...
                            width="50" height="50"/>
                            <span className="d-inline-block align-top custom-text">Men's Grooming</span>
                    </a>
            ...
            <div className="container section-title-container"><h3 className="section-title section-title-bold-center">
                <b></b><span
            ...
            <div className="container">
                ...
                <div className="trending">
                    <div>
                        <img src="https://static.30shine.com/shop-admin/2023/05/16/30S4HPU5-Reuzel-Pink-Pomade.jpg"/>
                ...
                <div className="stories">
                    <div>
                        <img src="https://static.30shine.com/shop-admin/2023/07/12/30SSYJGX-gia-sap-vuot-toc-nam.jpg"/>
                            <h5>GỢI Ý 12+ LOẠI POMADE NÊN SỬ DỤNG TRONG 2023 CHO ANH EM</h5>
                    </div>
                    <div>
                        <img src="https://static.30shine.com/shop-admin/2023/08/16/30STFSO0-sap-vuot-toc-nam-mem.jpg"/>
            ...
            <div className="container my-3">
                <div className="row my-3">
                    <div className="col-md-4 my-3">
                        <h3>Về chúng tôi</h3>
                        <p>
                            Chúng tôi cung cấp các sản phẩm mỹ phẩm chất lượng cao dành cho nam giới. Được tạo nên để
                            nâng cao
